...
| 	- Språk i brukergrensesnitt (`Se systemdokumentasjon for støttede språk`__)
| 	- Språk for utdata (`Se systemdokumentasjon for støttede språk`__)
| 	- Mørk/lys modus.

.. _supportedLanguages: Systemdokumentasjon.html#multilingual-support
__ supportedLanguages_
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Arkade CLI støtter fra og med versjon 2.3.0 valg av språk for utdata fra applikasjonen. `Se systemdokumentasjon for hvilke språk Arkade støtter <Systemdokumentasjon.html#multilingual-support>`_. Standard fil- og katalognavn, samt innhold i filer i tabellen under vil endres til valgt språk.

+-------------------------------+--------------------+-----------------+-----------------+---------------------+--------------------+
| Standard navn                 | :command:`process` | :command:`pack` | :command:`test` | :command:`generate` | :command:`analyse` |
+===============================+====================+=================+=================+=====================+====================+
| /Arkaderesultater-{GUID}/     |         X          |        X        |                 |                     |                    |
+-------------------------------+--------------------+-----------------+-----------------+---------------------+--------------------+
| /Arkaderapport-{GUID}.html    |         X          |        X        |        X        |                     |                    |
+-------------------------------+--------------------+-----------------+-----------------+---------------------+--------------------+
| /filformatinfo.csv            |         X          |        X        |                 |                     |         X          |
+-------------------------------+--------------------+-----------------+-----------------+---------------------+--------------------+
| /filformatinfo-statistikk.csv |         X          |        X        |                 |                     |         X          |
+-------------------------------+--------------------+-----------------+-----------------+---------------------+--------------------+
| /arkade-ip-metadata.json      |                    |                 |                 |          X          |                    |
+-------------------------------+--------------------+-----------------+-----------------+---------------------+--------------------+
| /noark5-testselection.txt     |                    |                 |                 |          X          |                    |
+-------------------------------+--------------------+-----------------+-----------------+---------------------+--------------------+
